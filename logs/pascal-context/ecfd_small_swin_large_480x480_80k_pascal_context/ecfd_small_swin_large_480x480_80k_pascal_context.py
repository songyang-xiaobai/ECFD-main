...
dist_params = dict(
    backend='gloo', init_method='tcp://b02r3n02:62141', world_size=8, rank=0)
log_level = 'INFO'
load_from = None
resume_from = None
workflow = [('train', 1)]
...
work_dir = 'addition_works/pascal_context/ecfd_small_swin_large_480x480_80k_pascal_context'
gpu_ids = range(0, 1)
