...
def load_pretrained(model, cfg=None, num_classes=1000, in_chans=3, filter_fn=None, strict=True, pos_embed_interp=False, num_patches=576, align_corners=False, pretrained_dir=None):
    if cfg is None:
    ...
    elif pretrained_dir is not None:
        state_dict = torch.load(pretrained_dir, map_location='cpu')['model']
    else:
