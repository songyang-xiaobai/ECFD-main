...
class MobileNetV3NoDilation(nn.Module):
    ...
    def __init__(self,
                 ...
                 norm_eval=False,
                 with_cp=False):
        super(MobileNetV3NoDilation, self).__init__()
    ...
    def _make_layer(self):
        ...
        if self.arch == 'small':
            ...
            for i in range(4, len(layers)):
                ...
                if i < 9:
                    modified_module.dilation = (1, 1)  # (2, 2)
                    pad = (modified_module.kernel_size[0] - 1) // 2
                else:
                    modified_module.dilation = (1, 1)  # (4, 4)
                    pad = (modified_module.kernel_size[0] - 1) // 2
    ...
    def train(self, mode=True):
        super(MobileNetV3NoDilation, self).train(mode)
        self._freeze_stages()
