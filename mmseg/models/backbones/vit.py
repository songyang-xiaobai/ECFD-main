...
class VisionTransformer(nn.Module):
    ...
    def init_weights(self, pretrained=None):
        ...
        if isinstance(pretrained, str):
            ...
            # pre = torch.load(pretrained, map_location='cpu')
            load_pretrained(self, num_classes=self.num_classes, in_chans=self.in_chans,
                                pos_embed_interp=self.pos_embed_interp,
                                num_patches=self.patch_embed.num_patches, align_corners=self.align_corners, pretrained_dir=pretrained)
