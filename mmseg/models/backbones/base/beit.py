...
class HybridEmbed(nn.Module):
    ...
    def __init__(self, backbone, img_size=(512, 512), feature_size=None, in_chans=3, embed_dim=768):
        super().__init__()
...
class BEiT(nn.Module):
    ...
    def __init__(self, img_size=(512, 512), patch_size=16, in_chans=3, num_classes=80, embed_dim=768,
