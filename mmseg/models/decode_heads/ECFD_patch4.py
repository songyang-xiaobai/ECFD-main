...
class ECFDPatch4(BaseDecodeHead):
    def __init__(self,
        ...
        super(ECFDPatch4, self).__init__(**kwargs)
...
class SpatialInformationCorrectionModule(nn.Module):
    def __init__(self, dim, num_heads=6, n_points=4, n_levels=1, deform_ratio=1.0,
                 with_mlp=True, SICM_mlp_ratio=0.25, drop=0., drop_path=0.,
        ...
        self.with_cp = with_cp
        if with_mlp:
            self.Mlp = Mlp(in_features=dim, hidden_features=int(dim * SICM_mlp_ratio), drop=drop)
