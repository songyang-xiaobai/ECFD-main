...
class ECFDGeneral(BaseDecodeHead):
    def __init__(self,
        ...
        super(ECFDGeneral, self).__init__(**kwargs)
        ...
        self.RCE = ReinforceContextEmbedding(
            ...
            in_chans=self.in_channels, is_fuse=False, align_corners=self.align_corners)
        ...
        self.up = nn.Conv2d(embed_dim, self.channels, kernel_size=1, bias=True)
    ...
    def forward(self, inputs):
        ...
        for i in range(self.L):
            x = self.blocks[i](x, deform_inputs1, deform_inputs2, space_shape)
    ...
    def deform_inputs(self, inputs):
        ...
        spatial_shapes = torch.as_tensor([(h1, w1)], dtype=torch.long, device=inputs[0].device)
